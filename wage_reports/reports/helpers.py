...
def calculate_social_security_generic(overall_gross,social_security_threshold,lower_social_security_percentage,upper_social_security_percentage,is_required_to_pay_social_security):
    ...
    if overall_gross <= social_security_threshold:
        ...
        sum_to_calculate_as_upper_social_security_percentage = (overall_gross - social_security_threshold)
        
    diminished_sum = sum_to_calculate_as_lower_social_security_percentage * lower_social_security_percentage
    standard_sum = sum_to_calculate_as_upper_social_security_percentage * upper_social_security_percentage
    total = diminished_sum + standard_sum
...
def calculate_monthly_net(overall_gross, output_tax, social_security_employee, income_tax ):
    return overall_gross + output_tax - social_security_employee - income_tax
